class Jogador {
  constructor(x, y) {
    ...
    this.cooldownDash = CONFIG.JOGADOR.DASH.COOLDOWN || 1500; // Valor padrão do config
...
if (this.podeDash()) {
  ...
  console.log("Dash em cooldown. Tempo restante: " + 
    (this.cooldownDash - (millis() - this.ultimoDash)) + "ms");
}
  }
