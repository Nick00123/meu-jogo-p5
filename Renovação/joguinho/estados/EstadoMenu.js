  ...
  aoPressionarTecla() {
    if (keyCode === UP_ARROW) {
      ...
      switch (this.selectedOption) {
        case 0: gerenciadorEstadoJogo.mudarEstado('SELECAO_PERSONAGEM'); break;
        case 1: gerenciadorEstadoJogo.mudarEstado('CONFIGURACOES'); break;
        case 2: gerenciadorEstadoJogo.mudarEstado('RECORDES'); break;
      }
    }
  }
}